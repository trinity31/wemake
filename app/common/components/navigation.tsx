...
export default function Navigation() {
    return <nav className="flex px-20 h-15 items-center justify-between backdrop-blur fixed top-0 left-0 right-0 z-50 bg-background/50">
